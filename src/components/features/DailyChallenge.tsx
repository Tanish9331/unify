...
const DailyChallenge: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-16 mb-24">
      ...
      <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg p-6 rounded-xl border border-white/20 dark:border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-4">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg bg-background border focus:ring-2 focus:ring-sky-500 outline-none transition-all"
        ...
        {showReward && currentReward && (
          <div className="mt-6 p-4 rounded-lg bg-gradient-to-r from-sky-50/80 to-blue-50/80 dark:from-sky-900/30 dark:to-blue-900/30 backdrop-blur-sm border border-sky-100 dark:border-sky-800 text-center">
